...
# Submit your PR on this new repo [Hacktoberfest2022](https://github.com/Pbjaishreeram11/Hacktoberfest2022) , There we are merging all valid PRs. 
...
```terminal
git clone https://github.com/Pbjaishreeram11/hacktoberfest2022.git
```
...
```terminal
git remote add upstream https://github.com/Pbjaishreeram11/hacktoberfest2022
```
